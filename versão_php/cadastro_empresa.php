...
<head>
  ...
  <title>Cadastro empresa - Accessy</title>
...
<body>
  ...
  <main>
    <form method="POST" action="./src/processamento/processa_empresa.php">
      <?php
      ...
      <div class="form-container">
        ...
        <textarea name="descricao_da_vaga"></textarea>

        <div class="form-link">
          <a href="./form_login.php?tipo=empresa" aria-label="Link que redireciona para a página de login de empresa">Entrar em conta já criada</a>
        </div>
      </div>
