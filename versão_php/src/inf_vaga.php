...
<head>
  ...
  <title>Vagas selecionada - Accessy</title>
...
<body id="zoombody">
  ...
  <main>
    ...
    <div class="campo-vagas">
      ...
      $result_vaga = "SELECT * FROM tb_vagas WHERE id = '$id'";
      $resultado_vaga = mysqli_query($conn, $result_vaga);
      $row_vaga = mysqli_fetch_assoc($resultado_vaga);
      ...
      print '
        <div class="card">
                <div class="cancel-button">
                  <a href="./vagas.php" aria-label="Link que redireciona a página de busca de vagas">
                    <svg width="47" height="43" viewBox="0 0 47 43" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M3.61538 43L0 39.6923L19.8846 21.5L0 3.30769L3.61538 0L23.5 18.1923L43.3846 0L47 3.30769L27.1154 21.5L47 39.6923L43.3846 43L23.5 24.8077L3.61538 43Z" fill="white" />
                    </svg>
                  </a>
                ...
                <div class="top-header-description">
                    <div class="top-header-card">
                        <div class="card-logo-vaga">
                            <img src="' . $row_vaga['path'] . '" alt="Imagem ilustrativa referente a logo da empresa que disponibilizou a vaga" />
                            <p>' . $row_vaga['nome_vaga'] . '<br />
                                <span>' . $row_vaga['salario_vaga'] . '</span>
                            </p>
                        </div>
                    </div>
                ...
                <p class="descricao-vaga">
                    ' . $row_vaga['descricao_vaga'] . '';

                    
                    if (isset($_SESSION['id_usuario'])) {
                      print ' <div class="favorite-button">
                      <a title="Favoritar vaga" aria-label="Favoritar vaga" href="./processamento/processa_favoritar_vagas.php?id_vaga=' . $row_vaga['id'] . '">
           ...
           print' <hr />
            ...
            <div class="box-button">
                <a href="' . $row_vaga['link_vaga'] . '" class="button" title="Link que redireciona ao contato da vaga atual" aria-label="Link que redireciona ao contato da vaga atual" >Entrar em contao</a>
            </div>
